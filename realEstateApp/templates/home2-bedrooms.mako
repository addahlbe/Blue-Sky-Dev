...
<!-- Main Page Content and Sidebar -->
  ...
  <div class="row" id="mainBody">
    <div class="large-12 columns" style="margin-top:20px">
      ...
      <br />
      <br />
        <a href="/home2"><center><h1>Home Style 2, 423 Teton Circle</h1></center></a>
      </div>
    </div>
    ...
    <aside class="large-3 columns">
      ...
      <h5>Categories</h5>
      <ul class="side-nav">
        <li><a href="#Master_View_1">Master View 1</a></li>
        <li><a href="#Master_View_2">Master View 2</a></li>
        <li><a href="#Bedroom_2">Bedroom 2</a></li>
        <li><a href="#Bedroom_3">Bedroom 3</a></li>
        <li><a href="#Bedroom_4">Bedroom 4</a></li>
        <li><a href="#Bedroom_5">Bedroom 5 (Lower Level)</a></li>
