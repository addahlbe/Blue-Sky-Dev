...
<body>
  ...
  <div class="row" id="mainBody">
    ...
    <aside class="large-3 columns">
      ...
      <h5>Categories</h5>
      <ul class="side-nav">
        <li><a href="#Master_Staged">Master Staged</a></li>
        <li><a href="#Master">Master</a></li>
        <li><a href="#Bedroom_2_View_1">Bedroom 2 View 1</a></li>
        <li><a href="#Bedroom_2_View_2">Bedroom 2 View 2</a></li>
        <li><a href="#Bedroom_3">Bedroom 3</a></li>
        <li><a href="#Bedroom_4_View_1">Bedroom 4 View 1</a></li>
