...
<body>
  ...
  <div class="row">
    ...
    <div class="large-9 columns" role="content">
      ...
      <article>
        <div class="row">
          <a id="Family_Room"></a>
          <div class="large-12 columns">
            <img src="/style/images/home2/familyroom_1200.jpg"/>
          </div>
        </div>
      </article>
      ...
      <article>
        <div class="row">
          <a id="Wet_Bar"></a>
          <div class="large-12 columns">
            <img src="/style/images/home2/wetbar_1200.jpg"/>
          </div>
        </div>
      </article>
    ...
    <aside class="large-3 columns">
      ...
      <h5>Categories</h5>
      <ul class="side-nav">
        <li><a href="#View_1">View 1</a></li>
        <li><a href="#View_2">View 2</a></li>
        <li><a href="#Family_Room">Family Room</a></li>
        <li><a href="#Wet_Bar">Wet Bar</a></li>
